...
export const PipelineEvents: CollectionConfig = {
  ...
  admin: { useAsTitle: 'id', group: 'Pipeline', defaultColumns: ['lead', 'from_status', 'to_status', 'triggered_by', 'createdAt'] },
  fields: [
    ...
    { name: 'decision_data', type: 'json' },
    { name: 'policy_check_result', type: 'select', options: ['pass', 'blocked', 'bypassed'] },
    { name: 'human_approved', type: 'checkbox' },
    { name: 'human_approved_by', type: 'text' },
    { name: 'human_approved_at', type: 'date' },
  ],
}
