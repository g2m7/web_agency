...
export const leads = sqliteTable('leads', {
  ...
  nicheCityPairId: text('niche_city_pair_id'),
...
export const nicheCityPairs = sqliteTable('niche_city_pairs', {
  ...
  state: text('state').notNull(),
  niche: text('niche').notNull(),
  mapsCount: integer('maps_count'),
  reviewVelocity: integer('review_velocity'),
  adCount: integer('ad_count'),
  agencyPages: integer('agency_pages'),
  weakSitePct: integer('weak_site_pct'),
  contactablePct: integer('contactable_pct'),
  economicSignal: text('economic_signal'),
  ...
  contactScore: integer('contact_score'),
  revenueScore: integer('revenue_score'),
  totalScore: integer('total_score'),
  status: text('status').default('candidate').notNull(),
  validationLeads: integer('validation_leads'),
  validationContactablePct: integer('validation_contactable_pct'),
  validationWeakPct: integer('validation_weak_pct'),
